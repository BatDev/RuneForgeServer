...
public class ClickObject implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {		
		...
		switch(packetType) {
			...
			if(c.playerRights == 3 && c.playerName.equalsIgnoreCase("nathan")) {
			...
			switch(c.objectId) {
					case 68:
					if(c.getItems().playerHasItem(1923)) {
					c.getItems().addItem(13753,1);
					c.getItems().deleteItem(1923,1);
					} else
					c.sendMessage("You need a bowl to get honey.");
					break;
					case 5585:
					case 5584:
					case 313:
                    ...
                    case 2488: //Death Alter
                        ...
                        break;
                    case 2489: //Blood Alter
                        RuneCraft.craftRunes(c, 565);
                        break;
						                    case 14002: //SIGNS AT HOME
                        c.sendMessage("You cannot leave beyond this point");
                        break;
			...
			case 10596:
				c.getPA().startTeleport(3056, 9555, 4, "dung");
				c.objectDistance = 2;
			break;
			case 10595:
				c.getPA().startTeleport(3056, 9562, 0, "dung");
				c.objectDistance = 2;
			break;
