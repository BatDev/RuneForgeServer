...
public class Item {
	...
	public static boolean playerCape(int itemId) {
		String[] data = {
			"cloak", "Dungeoneering master cape", "cape", "Cape", "attractor", "Attractor", "Ava's", "Dungeoneering Cape", "Dungeoneering Cape(T)", "Ardounge Cloak",
		};
	...
	public static boolean playerShield(int itemId) {
		String[] data = {
			"kiteshield", "deflector", "book", "Kiteshield", "toktz-ket-xil", "Toktz-ket-xil", "shield", "Shield", "page", "frost", "tome", "Tome", "Frost", "Kite", "kite", "Defender", "defender"
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerHats(int itemId) {
		String[] data = {
			...
			"Bomber cap", "headdress", "Top hat", "Royal crown", "Pernix Cowl", "Virtus Mask",
		};
		String item = getItemName(itemId);
		if (item == null) {
			return false;
	...
	public static boolean playerLegs(int itemId) {
		String[] data = {
			"tassets", "chaps", "bottoms", "gown", "trousers", "MarshBot", "Pernix Chaps", "Virtus Robelegs",
	...
	public static boolean playerBody(int itemId) {
		String[] data = {
			"body", "top", "Priest gown", "apron", "shirt", "Pernix Body", "Virtus Robetop",
			"platebody", "robetop", "body(g)", "body(t)", "White platebody", "Wizard robe (g)", "Wizard robe (t)",
	...
	private static String[] fullbody = {
		"top", "chestplate", "shirt","platebody","Ahrims robetop", "White platebody", "Armdayl_Body", "Armadyl body", "Armadyl Body",
		"Elite void knight top", "Karils leathertop","brassard","Robe top","robetop", "Vesta's chainbody", "Wizard robe (g)", "Wizard robe (t)",
		"platebody (t)","platebody (g)","chestplate", "Lord Marshal Top", "Primal platebody", "Virtus Robetop", "Pernix Body",
	...
	private static String[] fullhat = {
		...
		"Coif","Helm of neitiznot","Armadyl helmet","Berserker helm", "Bearhead", "Pernix Cowl", "Virtus Mask",
	...
	private static String[] fullmask = {
		"full helm", "Royal crown", "headdress", "mask", "Torva Fullhelm", "Pernix Cowl", "Virtus Mask", "Verac's helm", "Guthan's helm", "Karil's coif", "mask", "Torag's helm", "sallet", "Saradomin helm", "Lunar helm", "Dragon Mask", "dragon mask",
	};
		...
		try {
			...
			while ((c = dataIn.read()) != -1) {
				if (c == 0) {
					...
					itemStackable[12434] = true;//unicorn scroll
					itemStackable[12435] = true;//pack yak scroll
				} else {
