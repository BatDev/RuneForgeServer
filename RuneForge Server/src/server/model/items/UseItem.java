...
public class UseItem {
	...
	c.Summoning.ItemonItem(itemUsed, useWith);
		if (itemUsed == 10027) { 
			...
			if (c.playerLevel[21] >= 71) {
				...
				c.getItems().addItem(10028, 1);
				c.sendMessage("You have banked a "+c.getItems().getItemName(useWith)+"."); 
			} else {
				c.sendMessage("You don't have a high enough Hunter level.");
			}
		}
		...
		if (useWith == 10027) { 
			...
			if (c.playerLevel[21] >= 71) {
				c.getItems().bankItem(itemUsed, c.getItems().getItemSlot(itemUsed), 1);
				c.getItems().deleteItem(useWith, c.getItems().getItemSlot(useWith), 1);
				c.getItems().addItem(10028, 1);
				c.sendMessage("You have banked a "+c.getItems().getItemName(itemUsed)+"."); 
			} else {
				c.sendMessage("You don't have a high enough Hunter level.");
			}
		}
		 ...
		 **/
		if (itemUsed == 12435) { 
			if (c.lastsummon == 6874 || c.lastsummon == 6873) {
				c.getItems().bankItem(useWith, c.getItems().getItemSlot(useWith), 1);
		...
		if ((itemUsed == 995 && useWith == 10521) || (itemUsed == 10521 && useWith == 995)) {
			if ((c.getItems().playerHasItem(995) == true) && c.coinBag <= 2147000000 && c.coinBag >= 0) {
				CoinBag.addCoinsToBag(c);
			if ((c.getItems().playerHasItem(995) == true) && c.coinBag >= 2147000000) {
				c.sendMessage("no");
				return;
				}
		}
	...
	if ((itemUsed == 2357 && useWith == 1163) || (itemUsed == 1163 && useWith == 2357)) {
			if (c.playerLevel[c.playerSmithing] >= 99) {
				...
				c.sendMessage("You need a smithing level of 99 to create a Rune full helm(G).");
			}
		}
	if (itemUsed == 1165 && useWith == 2357 || itemUsed == 2357 && useWith == 1165) {
		if (c.playerLevel[c.playerSmithing] >= 90) {
				...
				c.sendMessage("You need a smithing level of 90 to create a Black full helm(G).");
			}
		}
	if (itemUsed == 1125 && useWith == 2357 || itemUsed == 2357 && useWith == 1125) {
		if (c.playerLevel[c.playerSmithing] >= 90) {
				...
				c.sendMessage("You need a smithing level of 90 to create a Black platebody(G).");
			}
		}
	if (itemUsed == 1077 && useWith == 2357 || itemUsed == 2357 && useWith == 1077) {
		if (c.playerLevel[c.playerSmithing] >= 90) {
				...
				c.sendMessage("You need a smithing level of 90 to create a Black platelegs(G).");
			}
		}
	if (itemUsed == 1079 && useWith == 2357 || itemUsed == 2357 && useWith == 1079) {
		if (c.playerLevel[c.playerSmithing] >= 99) {
				...
				c.sendMessage("You need a smithing level of 99 to create a Rune platebody(G).");
			}
		}
	if (itemUsed == 1127 && useWith == 2357 || itemUsed == 2357 && useWith == 1127) {
		...
		*/
		...
		if (itemUsed >= 14472 && itemUsed <= 14476 && useWith >= 14472 && useWith <= 14476) {
			if (c.getItems().hasAllLumps()) {
				c.getItems().makePlate();
			}		
		}
